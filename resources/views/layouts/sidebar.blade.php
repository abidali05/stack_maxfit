<div class="pb-3 sidebar pe-4">
    <nav class="navbar bg-light navbar-light">
        ...
        <div class="navbar-nav w-100 sidebar-small">
            ...
            <a href="{{ route('competitions.index') }}" class="nav-item nav-link">
                <i class="fa fa-money-check-alt me-2"></i>Competitions
            </a>

            <a href="{{ route('results.index') }}" class="nav-item nav-link">
                <i class="fa fa-money-check-alt me-2"></i>Results
            </a>
            ...
            <a href="{{ route('competitions.competitionVideos') }}" class="nav-item nav-link">
                <i class="fa fa-money-check-alt me-2"></i>Competition Videos
            </a>

            <a href="{{ route('competitions.appeals') }}" class="nav-item nav-link">
                <i class="fa fa-money-check-alt me-2"></i>Appeals
            </a>
