<div class="pb-3 sidebar pe-4">
    <nav class="navbar bg-light navbar-light">
        ...
        <div class="navbar-nav w-100 sidebar-small">
            ...
            <div class="nav-item dropdown">
                <a href="#"
                    class="nav-link dropdown-toggle {{ Route::is('competitions.*') || Route::is('competition-users.*') || Route::is('competition-details.*') || Route::is('results.*') ? 'active' : '' }}"
                    data-bs-toggle="dropdown">
                    <i class="fas fa-trophy me-2"></i>Competitions
                </a>
                <div class="bg-transparent border-0 dropdown-menu">
                    <a href="{{ route('branch.getCompetitions') }}"
                        class="nav-item nav-link {{ Route::is('branch.getCompetitions') || Route::is('branch.competitions.create') || Route::is('branch.competitions.edit') || Route::is('competitions.show') ? 'active' : '' }}">
                        <i class="fas fa-trophy me-2"></i>Competitions
                    </a>
                    <a href="{{ route('branch.competitions.videos') }}"
                        class="nav-item nav-link {{ Route::is('branch.competitions.videos') ? 'active' : '' }}">
                        <i class="fas fa-video me-2"></i>Videos
                    </a>
                    <a href="{{ route('branch.competitions.appeals') }}"
                        class="nav-item nav-link {{ Route::is('branch.competitions.appeals') ? 'active' : '' }}">
